...
class TestOps(unittest.TestCase):
  ...
  def test_multinomial(self):
    helper_test_op(probs=[4.2,1.8,2.4,1.6],4,False, lambda xs,sz,replacement: torch.multinomial(probs,sz,replacement, generator=Tensor._seed)) #fix this we need to get tinygrad rng and put it here its static shud be ez so we can pseudo stuff in sync with tiny exec multinomial ou crl
